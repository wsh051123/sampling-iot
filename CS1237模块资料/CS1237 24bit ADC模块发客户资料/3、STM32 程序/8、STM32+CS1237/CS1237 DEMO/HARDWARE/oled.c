...
void OLED_ShowDianya(unsigned long dat)
{
	uint32_t a,b;
	a = dat/1000000;
	b = dat%1000000;
	if(PoolFlag == 1)
		OLED_ShowChar(0,40,'-',16,1);
	else OLED_ShowChar(0,40,'+',16,1);
	OLED_ShowNum(8,40,a,1,16,1);
	OLED_ShowChar(16,40,'.',16,1);
	OLED_ShowNum(24,40,b,6,16,1);
	OLED_ShowChar(78,40,'V',16,1);
}
